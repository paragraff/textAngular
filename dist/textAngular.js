...
.factory('taBrowserTag', [function(){
    ...
    var rsb1 = new RegExp(/<span( class="rangySelectionBoundary")? id="selectionBoundary_\d+_\d+"( class="rangySelectionBoundary")?>[^<>]+?<\/span>/ig);
    var rsb2 = new RegExp(/<span( class="rangySelectionBoundary")? id="selectionBoundary_\d+_\d+"( class="rangySelectionBoundary")?>[^<>]+?<\/span>/ig);
    var rsb3 = new RegExp(/<span( class="rangySelectionBoundary")? id="selectionBoundary_\d+_\d+"( class="rangySelectionBoundary")?>[^<>]+?<\/span>/ig);
